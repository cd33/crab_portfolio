...
// ---------------------------------------------------------------------------
// Helpers pour sérialiser/désérialiser les Set (JSON ne les supporte pas)
// ---------------------------------------------------------------------------
...
export const useStore = create<StoreState>()(
  persist(
    ...
    {
      name: 'crab-portfolio-store',
      // Ne persister que les données de progression et préférences utilisateur.
      // Exclure les états UI temporaires (modals ouverts, etc.).
      partialize: (state) => ({
