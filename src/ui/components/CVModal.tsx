...
export function CVModal() {
  ...
  return (
    ...
    >
      ...
      >
        {/* CV Viewer */}
        <div className="p-6 pt-2 overflow-y-auto max-h-[calc(90vh)] bg-gray-900/50">
        ...
        <div className="p-6 bg-gradient-to-r from-gray-800 to-gray-900 border-t-2 border-gray-700 flex justify-center gap-4">
          <button
            onClick={handleDownload}
            className="group relative px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-green-500/50 flex items-center gap-3"
          >
            <Download className="w-6 h-6 animate-bounce group-hover:animate-none" />
            <span className="text-lg">{t('cv.download')}</span>
          ...
          <a
            ...
            className="group relative px-8 py-4 bg-gradient-to-r from-blue-700 to-blue-600 hover:from-blue-800 hover:to-blue-500 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/50 flex items-center gap-3"
          ...
          >
            ...
            <span className="text-lg group-hover:text-white">{t('cv.linkedin')}</span>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative px-8 py-4 bg-gradient-to-r from-gray-900 to-purple-900 hover:from-gray-800 hover:to-purple-700 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-purple-500/50 flex items-center gap-3"
          ...
          >
            ...
            <span className="text-lg group-hover:text-white">{t('cv.github')}</span>
